...
function targetList() {
  const list = [
    ...
    'components/quote/index.html',
    'components/timeline/index.html',
    'components/media/index.html',
    'components/lists/index.html',
    'components/citation-list/index.html',
...
const CURRENT = {
  ...
  'components/callout/index.html':{ section: 'Components', group: 'Content &amp; display', href: '{{base}}components/callout/' },
  'components/quote/index.html':{ section: 'Components', group: 'Content &amp; display', href: '{{base}}components/quote/' },
  'components/timeline/index.html':{ section: 'Components', group: 'Content &amp; display', href: '{{base}}components/timeline/' },
  'components/media/index.html':{ section: 'Components', group: 'Content &amp; display', href: '{{base}}components/media/' },
  'components/lists/index.html':{ section: 'Components', group: 'Content &amp; display', href: '{{base}}components/lists/' },
  'components/citation-list/index.html':{ section: 'Components', group: 'Content &amp; display', href: '{{base}}components/citation-list/' },
  'components/table/index.html':{ section: 'Components', group: 'Content &amp; display', href: '{{base}}components/table/' },
